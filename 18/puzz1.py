...
if __name__ == '__main__':
    ...
    G = get_grid('18/input', plot=False, render=True)
    times = []
    for i in range(5):
        start = time.time()
    ...
    print(f"Times to complete part 1: {time_str}")
    print(f'Average computation time: {avg_time:.2f}s')

    # Answer is 5262 in 16.11s, 15.36s, 14.82s, 14.88s, 14.17s
    # Average computation time: 15.07s