...
def get_max_observable(fname):
    ...
    return max_loc, max_visible

if __name__ == '__main__':

    assert get_max_observable('10/test_input')[1] == 8
    assert get_max_observable('10/test_input2')[1] == 33
    assert get_max_observable('10/test_input3')[1] == 35
    assert get_max_observable('10/test_input4')[1] == 41
    assert get_max_observable('10/test_input5')[1] == 210

    print(get_max_observable('10/input'))
